...
- **12 analysis tabs**:
  ...
  9. **💎 Smart Money** *(NEW)* — auto-reads of top 10 holdings + full M-Block analyzer (candlestick chart, swing detection, BOS, MB zones, trade-grade checklist, risk calculator, persistent journal)
  10. **🧾 Tax-Loss Harvesting** *(NEW)* — flags lots with harvestable losses; separates long-term vs short-term
  11. **📰 News & Earnings** *(NEW)* — upcoming earnings calendar + latest headlines per holding
  12. **Exports** — enriched CSVs, TradingView-format CSVs, TLH candidates, full ZIP bundle, *PDF dashboard summary*
